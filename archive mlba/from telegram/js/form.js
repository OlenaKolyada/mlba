document.addEventListener('DOMContentLoaded', function () {
    ...
    const ageRadios = document.querySelectorAll('input[name="age-participant"]');
    ...
    const firstParticipant = document.querySelector('.participant-identity-block');
    ...
    document.querySelector('.add-participant').addEventListener('click', function () {
        ...
        newParticipant.querySelectorAll('input[type="radio"]').forEach(radio => radio.name = 'age-participant-' + participantCount);
    ...
    function setupNewParticipantToggle(block, index) {
        const radios = block.querySelectorAll('input[name="age-participant-' + index + '"]');
        ...
        const sections = {
            ...
            '10-12': block.querySelector('#elem-2-section-' + index),
            '13-14': block.querySelector('#elem-3-section-' + index),
