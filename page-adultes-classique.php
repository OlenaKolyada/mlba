                                ...
                                <div class="swiper swiper-section-small">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/loisir/adultes-classique/adultes-classique-1.jpg"
                                                 alt="Initiation à la danse classique"
                                                 title="Initiation à la danse classique">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/loisir/adultes-classique/adultes-classique-2.jpg"
                                                 alt="Initiation à la danse classique"
                                                 title="Initiation à la danse classique" />
                                        </div>
                                    </div>
