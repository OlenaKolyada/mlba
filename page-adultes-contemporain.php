    ...
    <main >
        ...
        <section class="section our-story section-second bg-white" id="our-story-1">
            <div class="section-wrap">
                <h1>Cours Adultes Contemporain</h1>
                                ...
                                <div class="swiper swiper-section-small">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/loisir/adultes-contemporain/adultes-contemporain-1.jpg"
                                                 alt="Initiation à la danse classique"
                                                 title="Initiation à la danse classique">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/loisir/adultes-contemporain/adultes-contemporain-2.jpg"
                                                 alt="Initiation à la danse classique"
                                                 title="Initiation à la danse classique" />
                                        </div>
                                    </div>
