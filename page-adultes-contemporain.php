                            ...
                            <div class="section-row">
                                <div class="section-content-text">
                                    <div class="section-text">
                                        ...
                                        <p>D’un point de vue technique, nous abordons les grands principes de la danse contemporaine&nbsp;:</p>
                                        <ul>
                                            <li>les appuis,</li>
                                        ...
                                        <p><strong>Lundi 19h15-20h45</strong></p>
                                        ...
                                        <div class="swiper swiper-section-small">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="<?php echo get_template_directory_uri();?>/assets/images/loisir/adulte-contemporain/adulte-contempo1.jpg" class="popup-gallery"  title="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova">
                                                        <img src="<?php echo get_template_directory_uri();?>/assets/images/loisir/adulte-contemporain/adulte-contempo1.jpg"
                                                             alt="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova"
                                                             title="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="<?php echo get_template_directory_uri();?>/assets/images/loisir/adulte-contemporain/adulte-contempo2.jpg" class="popup-gallery"  title="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova">
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="<?php echo get_template_directory_uri();?>/assets/images/loisir/adulte-contemporain/adulte-contempo3.jpg" class="popup-gallery"  title="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova">
                                            ...
                                            <div class="swiper-slide">
                                                    <a href="<?php echo get_template_directory_uri();?>/assets/images/loisir/adulte-contemporain/adulte-contempo4.jpg" class="popup-gallery"  title="Mikhalev Lanssens Ballet Academy, Danse Adulte Contemporain. Professeur Alexia Séré. Crédit photo Marina Kudryashova">
