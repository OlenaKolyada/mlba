 ...
 * Template name: Professeurs Invites
...
?>
    ...
    <main class="main professeurs" id="professeurs-invites">
    ...
    <!--	Ruslan Savdenov START-->
                            ...
                            <div class="three-list-row">
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        ...
                                        <li>Ballet de l’Opéra Tchaïkovski de Perm (Russie)</li>
                                        <li>Opéra national du Tatarstan (Kazan)</li>
                                ...
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        ...
                                        <li>«&nbsp;Le Lac des cygnes&nbsp;» (Siegfried, Pas de trois de l’acte III) de Rudolf Noureev</li>
                                        <li>«&nbsp;Don Quichotte&nbsp;» (rôle-titre) de Kader Belarbi</li>
                                        <li>«&nbsp;La Bayadère&nbsp;» (Solor, l’Idole d’or) de Alexandre Gorsky</li>
                                    ...
                                    <div class="hidden-text">
                                        <ul class="three-list-item-text">
                                            ...
                                            <li>«&nbsp;Giselle&nbsp;» (Albrecht) de Jules Perrot et Jean Coralli</li>
                                            <li>«&nbsp;La Belle au Bois Dormant&nbsp;» (Désiré) de Marius Petipa</li>
                                            <li>«&nbsp;Le Corsaire&nbsp;» (Conrad, Ali)  de Marius Petipa</li>
                                            <li>«&nbsp;Don Quichotte&nbsp;» (Basilio) de Marius Petipa</li>
                                            <li>«&nbsp;Les Mirages&nbsp;» (le Marchand) de Serge Lifar</li>
                                            <li>«&nbsp;Suite en blanc&nbsp;» de Serge Lifar</li>
                                            <li>«&nbsp;Roméo et Juliette&nbsp;» (Roméo) de Kenneth MacMillan</li>
                                            <li>«&nbsp;Winter Dreams&nbsp;» de Kenneth MacMillan</li>
                                            <li>«&nbsp;Roméo et Juliette&nbsp;» (Frère Laurent) de Jean-Christophe Maillot</li>
                                            <li>«&nbsp;Cendrillon&nbsp;» (le Prince) de Alexeï Mirochnitchenko</li>
                                            <li>«&nbsp;Chout-Le Bouffon&nbsp;» (rôle du Marchand) de Alexeï Mirochnitchenko</li>
                                            <li>«&nbsp;Casse-Noisette&nbsp;» (le Prince) de Vassili Vainonen</li>
                                            <li>«&nbsp;Carmen&nbsp;» (Don José) de Roland Petit</li>
                                            <li>«&nbsp;The Four Seasons&nbsp;» (Autumn) de Jerome Robbins</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        ...
                                        <li>«&nbsp;Toulouse-Lautrec&nbsp;» de Kader Belarbi</li>
                                        <li>«&nbsp;Les Liaisons dangereuses&nbsp;» (Valmont) de Davide Bombana</li>
                                        <li>«&nbsp;If To Leave Is To Remember&nbsp;» de Carolyn Carlson</li>
                                        <li>«&nbsp;The Second Detail&nbsp;» (Ion) de William Forsythe</li>
                                    ...
                                    <div class="hidden-text">
                                        <ul class="three-list-item-text">
                                            ...
                                            <li>«&nbsp;Nocturnes&nbsp;» de Thierry Malandain</li>
                                            <li>«&nbsp;Tablao&nbsp;» de Antonio Najarro</li>
                                            <li>«&nbsp;Fugaz&nbsp;» de Cayetano Soto</li>
                                            <li>«&nbsp;L’Après-midi d’un faune&nbsp;» (le Minotaure) de H. Wang et S. Ramirez</li>
                                        </ul>
                                    </div>
                                    <a href="#" class="read-more-link">
                                        <span class="text-open">Afficher plus</span>
        ...
        <!--	Aleksandra Surodeev START-->
            <section class="section-wrap" id="alexandra-surodeev">
                <div class="container">
                    <div class="section-row section-title">
                        <h2 class="title-has-subtitle">Aleksandra Surodeev</h2>
                        <div class="subtitle">
                                ...
                                <div class="three-list-row">
                                    ...
                                    <div class="three-list-item">
                                        ...
                                        <ul class="three-list-item-text">
                                            ...
                                            <li>«&nbsp;La Bayadère&nbsp;» (Nikiya) de Alexandre Gorsky</li>
                                            <li>«&nbsp;Roméo et Juliette&nbsp;» (Juliette, Scène du balcon, acte I) de Rudolf Noureev</li>
                                            <li>«&nbsp;Don Quichotte&nbsp;» (la Reine des Dryades) de Alexandre Gorsky</li>
                                            <li>«&nbsp;Spartacus&nbsp;» (Aegina) de Georgy Kovtun</li>
                                        ...
                                        <div class="hidden-text">
                                            ...
                                            <li>«&nbsp;Peer Gynt&nbsp;» (Solveig) de Georgy Kovtun</li>
                                            <li>«&nbsp;Les Mirages&nbsp;» (la Femme) de Serge Lifar</li>
                                            <li>«&nbsp;Suite en blanc&nbsp;» de Serge Lifar</li>
                                            <li>«&nbsp;Les Patineurs&nbsp;» de Frederick Ashton</li>
                                            <li>«&nbsp;Le Lac des cygnes&nbsp;» (Odette/Odile) de Natalia Makarova</li>
                                            <li>«&nbsp;Giselle&nbsp;» (rôle-titre) de Jules Perrot et Jean Coralli</li>
                                            <li>«&nbsp;Roméo et Juliette&nbsp;» (Juliette) de Kenneth MacMillan</li>
                                            <li>«&nbsp;La Bayadère&nbsp;» (variation d’une Ombre) de Rudolf Noureev</li>
                                            <li>«&nbsp;La Bayadère&nbsp;» (Le Royaume des Ombres, acte III) de Rudolf Noureev</li>
                                            <li>«&nbsp;Cendrillon&nbsp;» (rôle-titre, Pas de deux de l’acte II) de Rudolf Noureev</li>
                                            <li>«&nbsp;La Belle au bois dormant&nbsp;» (Aurore, la princesse Florine) de Marius Petipa</li>
                                            <li>«&nbsp;Le Corsaire&nbsp;» (Médora) de Marius Petipa</li>
                                            <li>«&nbsp;L’Arlésienne&nbsp;» (Vivette) de Roland Petit</li>
                                            <li>«&nbsp;The Four Seasons&nbsp;» (Spring) de Jerome Robbins</li>
                                            <li>«&nbsp;Coppélia&nbsp;» (Swanilda) de Arthur Saint-Léon</li>
                                            <li>«&nbsp;Casse-Noisette&nbsp;» (Clara) de Vassili Vainonen</li>
                                            </ul>
                                        </div>
                                        <a href="#" class="read-more-link">
                                            <span class="text-open">Afficher plus</span>
                                    ...
                                    <div class="three-list-item">
                                        ...
                                        <ul class="three-list-item-text">
                                            ...
                                            <li>«&nbsp;La Bête et la Belle&nbsp;» de Kader Belarbi</li>
                                            <li>«&nbsp;Casse-Noisette&nbsp;» (La Haute Surveillante, la Reine des Arachnides, la Reine des Flocons) de Kader Belarbi</li>
                                            <li>«&nbsp;Don Quichotte&nbsp;» (Mercedes, la Reine des Naïades) de Kader Belarbi</li>
                                        ...
                                        <div class="hidden-text">
                                            <ul class="three-list-item-text">
                                                ...
                                                <li>«&nbsp;Les Liaisons dangereuses&nbsp;» (Cécile de Volanges) de Davide Bombana</li>
                                                <li>«&nbsp;The Second Detail&nbsp;» (Tracy) de William Forsythe</li>
                                                <li>«&nbsp;Les Noces&nbsp;» (la Mariée) de Jiří Kylián</li>
                                                <li>«&nbsp;Souvenir&nbsp;» de Douglas Lee</li>
                                                <li>«&nbsp;Daphnis et Chloé&nbsp;» (Lycéion) de Thierry Malandain</li>
                                                <li>«&nbsp;Instars&nbsp;» de Erico Montes</li>
                                                <li>«&nbsp;Blanche-Neige et les sept Nains&nbsp;» (Blanche-Neige) de Boris Myagkov</li>
                                                <li>«&nbsp;Tablao&nbsp;» de Antonio Najarro</li>
                                                <li>«&nbsp;Vaslaw&nbsp;» de John Neumeier</li>
                                                <li>«&nbsp;La Dame aux camélias&nbsp;» (Violetta) de Alexander Polubentsev</li>
                                            <li>«&nbsp;Fugaz&nbsp;» de Cayetano Soto</li>
                                            </ul>
                                        </div>
                                        <a href="#" class="read-more-link">
            ...
            <!--	Aleksandra Surodeev END-->

        <!--	Vladimir Ippolitov START-->
        <section class="section-wrap" id="vladimir-ippolitov">
            <div class="container">
                <div class="section-row section-title">
        ...
        <!--	Vladimir Ippolitov END-->

        <!--	Yumi Aizawa START-->
        <section class="section-wrap" id="yumi-aizawa">
            <div class="container">
                <div class="section-row section-title">
                ...
                <div class="section-row">
                    <div class="section-content-text">
                        <div class="section-text">
                            <p>Yumi Aizawa, née à Matsumoto (Japon), commence la danse classique à l’âge de quatre ans à l’école Nagano Ballet, sous la direction de Teruyo Kurashima. Elle poursuit ensuite sa formation à la Hakucho Ballet Académie auprès de Mihori et Tamae Tsukada, Michiya Mika et Daiki Miura.</p>
                                <p>À 14 ans, elle est admise à la prestigieuse École du Ballet de Hambourg, dirigée par John Neumeier, où elle travaille notamment avec Marianne Kruuse, Kevin Haigen, Radik Zaripov et Ingrid Glindemann. Elle y obtient son diplôme en 2004.</p>
                            <p>La même année, à 17 ans, elle rejoint le Ballett Dresden (Sächsische Staatsoper Dresden) sous la direction de Vladimir Derevianko. Deux ans plus tard, en 2006, elle entre au Ballet de l’Opéra National de Bordeaux, dirigé par Charles Jude. Elle y danse pendant près de huit ans, interprétant de nombreux rôles principaux dans le grand répertoire classique — Aurore (La Belle au bois dormant), Juliette (Roméo et Juliette), Odile (Le Lac des cygnes), Swanie (Coppélia), Marie (Le Casse-Noisette), Myrtha (Giselle) — ainsi que dans les œuvres de George Balanchine, Jiří Kylián, Angelin Preljocaj, Carolyn Carlson et William Forsythe.</p>
                            <p>En 2014, elle rejoint le Ballet du Grand Théâtre de Genève, où elle danse sous les directions de Philippe Cohen puis de Sidi Larbi Cherkaoui. Elle y interprète des œuvres de Jirí Kylián (Petite Mort, Bella Figura), Sidi Larbi Cherkaoui (Faun, Noetic, Ukiyo-e, Bolero), Damian Jalet (Skid, Thr(o)ugh), Sharon Eyal (Strong), Andonis Foniadakis (Glory, Le Sacre du printemps) et bien d’autres chorégraphes contemporains majeurs.</p>
                            <p>Lauréate de plusieurs concours, elle a notamment été demi-finaliste au Prix de Lausanne (2003), 3ᵉ prix au Concours National de Ballet de Saitama (2002) et 2ᵉ prix au Concours NBA de Tokyo (1998).</p>
                            <p>Depuis 2015, elle est présidente de l’Association “Geneva Dance Events”, à Genève, qui promeut la culture chorégraphique et les échanges artistiques internationaux.</p>
                            <p>En 2025, Yumi Aizawa élargit encore son champ d’activité artistique et pédagogique. Elle fonde au Japon Danstep合同会社 (Danstep LLC), dont elle est la directrice. À travers cette structure, elle souhaite transmettre son expérience acquise en Europe et contribuer au développement de la danse au Japon, en créant des ponts entre les scènes artistiques japonaise et européenne. Elle participe également à divers projets artistiques en Europe, notamment en tant qu’assistante des chorégraphes Riva & Repele (Sasha Riva et Simone Repele) pour la transmission de leur pièce au Stuttgart Ballet.</p>
                            <p>Elle enseigne également lors de stages à Tokyo et organise des workshops à Nagoya. Ces nouvelles expériences illustrent son engagement dans la création, la transmission et le dialogue interculturel, ainsi que sa volonté de faire rayonner la danse au Japon à travers Danstep LLC, tout en poursuivant une carrière artistique active au sein du Ballet du Grand Théâtre de Genève.</p>
                        </div>
                    </div>
                    <div class="section-content-image">
                        <div class="frame">
                                ...
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        <li><strong>Depuis juin 2014</strong><br>
                                            ...
                                            <em>Directeur :</em> Philippe Cohen (- 2022)</li>
                                        <li><strong>2006–2014</strong><br>
                                            Ballet de l'Opéra National de Bordeaux, France<br>
                                            <em>Directeur :</em> Charles Jude<br>
                                            <strong>Première danseuse</strong> (Janvier 2012 - Juin 2014)<br>
                                            <strong>Soliste</strong> (Avril 2009 - Décembre 2011)<br>
                                            <strong>Corps de ballet</strong> (2006 - 2009)</li>
                                        <li><strong>2004–2006</strong><br>
                                            Ballett Dresden, Sächsische Staatsoper Dresden, Allemagne<br>
                                            <em>Directeur :</em> Vladimir Derevianko<br>
                                            Corps de ballet</li>
                                    </ul>
                                </div>
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        ...
                                        <li><strong>2001–2004</strong><br>
                                            L’école de Ballet d’Hambourg, Allemagne<br>
                                            <em>Directeur :</em> John Neumeier<br>
                                            <em>Enseignants :</em> Marianne Kruuse, Kevin Haigen, Radik Zaripov, Ingrid Glindemann etc</li>
                                        <li><strong>1990–2001</strong><br>
                                            Hakucho Ballet Academie, Japon<br>
                                            <em>Enseignants :</em> Mihori Tsukada, Tamae Tsukada, Michiya Mika, Daiki Miura</li>
                                        <li><strong>1990–1993</strong><br>
                                            L’école de Nagano Ballet, Japon<br>
                                ...
                                <div class="three-list-item">
                                    ...
                                    <ul class="three-list-item-text">
                                        ...
                                        <li><strong>2002</strong><br>
                                            Saitama National Ballet Concours, Tokyo :<br>3e Prix (division senior)</li>
                                        <li><strong>1998</strong><br>
                                            NBA Ballet Competition, Tokyo : 2e Prix (division junior)</li>
                                        <li><strong>1997</strong><br>
                                            Saitama National Ballet Concours, Tokyo :<br>2e Prix (division junior)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="four-list-item">
                                    ...
                                    <div class="hidden-text">
                                        <ul class="four-list-item-text">
                                            ...
                                            <li>Skid (Damian Jallet)</li>
                                            <li>Thr(o)ugh (Damian Jallet)</li>
                                            <li>Mirage (Damian Jallet)</li>
                                            <li>Bolero (Sidi Larbi Cherkaoui et Damian Jallet)</li>
                                            <li>Strong (Sharon Eyal)</li>
                                            <li>Glory (Andonis Foniadakis)</li>
                                            <li>Paron (Andonis Foniadakis)</li>
                                            <li>Le Sacre du printemps (Andonis Foniadakis)</li>
                                            <li>Return to Nothingness (Nathalia Horecina)</li>
                                            <li>Fallen (Andrew Skills)</li>
                                            <li>Carmina Burana (Claude Brumachon)</li>
                                            <li>Une Autre Passion (Pontus Lidberg)</li>
                                            <li>Callas (Reinhild Hoffmann)</li>
                                            <li>Elementen (Cindy Van Acher)</li>
                                            <li>Fearful Symmetory (Ioannis Mandafounis)</li>
                                            <li>Sed Lux Permanent (Ken Ossola)</li>
                                            <li>Mémoire de l’ombre (Ken Ossola)</li>
                                            <li>Le songe d’une nuit d’été (Michel Kelemenis)</li>
                                            <li>Le Casse-Noisette (Jeroen Verbruggen)</li>
                                            <li>Vena Amoris (Jeroen Verbruggen)</li>
                                            <li>Roméo and Juliette (Joëlle Bouvier)</li>
                                            <li>Tristan et Iseut (Joëlle Bouvier)</li>
                                            <li>Wahada (Abou Lagraa)</li>
                                        </ul>
                                    </div>
                                    <a href="#" class="read-more-link">
                                        <span class="text-open">Afficher plus</span>
                                ...
                                <div class="four-list-item">
                                    ...
                                    <div class="hidden-text">
                                        <ul class="four-list-item-text">
                                            ...
                                            <li>La Création (Uwe Scholz)</li>
                                            <li>Concerto pour piano No.3, Rachmaninov (Uwe Scholz)</li>
                                            <li>Wahlverwandtschaften (Les Affinités électives) (Tom Schilling)</li>
                                            <li>La Fille mal Gardée (Joseph Lazzini)</li>
                                            <li>Don Quixote (Vladimir Derevianko)</li>
                                            <li>Giselle (Vladimir Derevianko)</li>
                                            <li>Petrouchka (M. Fokine)</li>
                                            <li>l’Oiseau de feu (M. Fokine)</li>
                                            <li>Chopiniana (M. Fokine)</li>
                                        </ul>
                                    </div>
                                    <a href="#" class="read-more-link">
                                        <span class="text-open">Afficher plus</span>
                                ...
                                <div class="four-list-item">
                                    ...
                                    <div class="hidden-text">
                                        <ul class="four-list-item-text">
                                            ...
                                            <li>Raymonda (3rd act: Charles Jude)</li>
                                            <li>Violin Concerto (1st couple: George Balanchine)</li>
                                            <li>4 Tempéraments (Sanguin - George Balanchine)</li>
                                            <li>Apollon (Polyhymnia: George Balanchine)</li>
                                            ...
                                            <li>Numero Uno (Maurizio Weinrot)</li>
                                            <li>Tetris (Anthony Egea)</li>
                                            <li>Don Quixote (2 amies: Charles Jude)</li>
                                ...
                                <div class="four-list-item">
                                    ...
                                    <div class="hidden-text">
                                        <ul class="four-list-item-text">
                                            ...
                                            <li>Thème et Variations (rôle principale: Kevin Haigen)</li>
                                            <li>Pas de deux de l’oiseau bleu (John Neumeier)</li>
                                            <li>Le Sacre du printemps (John Neumeier)</li>
                                        </ul>
                                    </div>
                                    <a href="#" class="read-more-link">
...
<nav class="scroll-dots-nav" aria-label="Navigation de section">
    <ul>
        <li><a href="#ruslan-savdenov" data-target="ruslan-savdenov" data-offset="100" data-label="Ruslan Savdenov"></a></li>
        <li><a href="#alexandra-surodeev" data-target="alexandra-surodeev" data-offset="100" data-label="Alexandra Surodeev"></a></li>
        <li><a href="#vladimir-ippolitov" data-target="vladimir-ippolitov" data-offset="100" data-label="Vladimir Ippolitov"></a></li>
        <li><a href="#yumi-aizawa" data-target="yumi-aizawa" data-offset="100" data-label="Yumi Aizawa"></a></li>
    </ul>
</nav>
<!--Scroll Dots Nav END-->
<?php
