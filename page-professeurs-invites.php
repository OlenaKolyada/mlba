...
?>
    ...
    <main class="main" class="professeurs" id="professeurs-invites">
...
<nav class="scroll-dots-nav" aria-label="Navigation de section">
    <ul>
        <li><a href="#ruslan-savdenov" data-target="ruslan-savdenov" data-offset="150" data-label="Ruslan Savdenov"></a></li>
        <li><a href="#alexandra-surodeev" data-target="alexandra-surodeev" data-offset="150" data-label="Alexandra Surodeev"></a></li>
    </ul>
</nav>
<!--Scroll Dots Nav END-->
<?php
