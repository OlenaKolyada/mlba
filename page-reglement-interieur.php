 ...
 * Template name: Reglement Interieur
...
?>
    ...
    <!--	Article 1 START-->
    <section class="section-wrap no-padding-top longread" id="article1">
        <div class="container">
    ...
    <!--	Article 11 START-->
    <section class="section-wrap longread" id="article11">
        <div class="container">
            <div class="section-row">
                <div class="section-content-text">
                    <div class="section-text">
...
<nav class="scroll-dots-nav" aria-label="Navigation de section">
    <ul>
        ...
        <li><a href="#article11" data-target="article11" data-offset="100" data-label="Article 11"></a></li>
    </ul>
</nav>
<!--Scroll Dots Nav END-->
<?php
